Description of the node. Should be around 30-40 words. This should be dry, practical description. Ideally, the first line should describe the node succinctly.
